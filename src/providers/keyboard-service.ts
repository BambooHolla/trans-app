...
export class KeyboardService {
  ...
  public get fullHeight() {
    if (!this._fullHeight){
      ...
      console.log('platform.height():', platformHeight, 'computedHeight: ', computedHeight, platformHeight === computedHeight);
    }
  ...
  toggleContentHeight(keyboardShow: boolean, keyboardHeight: number){
    ...
    const rootComponent = document.querySelector('ion-app > ng-component') as HTMLElement;
    if (!rootComponent){
      return;
    }

...
o   11.1.4 本平台通过合法途径取得的其他您个人信息。 <br>
•   11.2 信息使用 <br>
...
   11.2.1.5 为了使您解本平台服务的具体情况，您同意本平台向其发送营销活动通知、商业性电子信息以及提供与您相关的广告以替代普遍投放的广告； <br>
...
了解你的客户和反洗钱政策 <br>
一、导言 <br>
•   1.1 我们保证审慎遵守“了解你的客户”和反洗钱相关的法律法规且不得故意违反该《了解你的客户和反洗钱政策》。在我们合理控制的范围内我们将采取必要的措施和技术为您提供安全的服务，尽可能使您免于遭受犯罪嫌疑人的洗钱行为带来的损失。 <br>
•   1.2 我们的了解你的客户和反洗钱政策是一个综合性的国际政策体系，包括您隶属的不同法律辖区的了解你的客户和反洗钱政策。我们健全合规的框架确保我们在本地和全球层面均符合监管要求和监管水平，并确保本平台持续性运行。 <br>
二、了解你的客户和反洗钱政策如下： <br>
•   2.1 颁布了解你的客户和反洗钱政策并时时更新以满足相应的法律法规规定的标准； <br>
•   2.2 颁布和更新运行本平台的一些指导原则和规则，且我们的员工将按照该原则和规则的指导提供服务； <br>
•   2.3 设计并完成内部监测和控制交易的程序，如以严格的手段验证身份，安排组建专业团队专门负责反洗钱工作； <br>
•   2.4 采用风险预防的方法对客户进行尽职调查和持续的监督; <br>
•   2.5 审查和定期检查已发生的交易; <br>
•   2.6 向主管当局报告可疑交易; <br>
•   2.7 身份证明文件、地址证明文件和交易记录的证明文件将会维持至少六年，如被提交给监管部门，恕不另行通知您。 <br>
...
o   3.1.2 如果您是一个公司或其他合法实体，我们将收集以下信息以确定您或信托帐户的最终受益人。 <br>
...
•   3.2 确认核实 <br>
o   3.2.1 我们要求您提供身份证明文件的全部页面内容。 <br>
o   3.2.2 我们要求您提供您将您的身份证明文件放在您胸前的照片。 <br>
o   3.2.3 证明文件的副本一般应核和原始凭证进行核对。然而，如果某个可信赖的合适的认证人可证明该副本文件是原始文件准确而全面的复制的，该副本可接受。这样的认证人包括大使、司法委员、地方治安官等。 <br>
...
•   4.2 如果交易频繁集中发生在某个注册用户或存在超乎合理的情况，我们的专业团队将评估并决定他们是否可疑; <br>
•   4.3 我们凭借自身的判断认定为可疑交易的情况，我们可能会采取暂停该交易、拒绝该交易等限制性措施，甚至如果可能将尽快逆转该交易，同时向主管部门报告，但不会通知您; <br>
•   4.4 我们保留拒绝来自于不符合国际反洗钱标准辖区的人或可被视为政治公众人物的人的注册申请，我们保留随时暂停或终止根据我们自身判断为可疑交易的交易，但我们这样做并不违反对您的任何义务和责任。</p>
      `,
        },
        en: {
            title: ``,
  ...
  o   8.2.3 当プラットフォームのサービスを通じて、データ、情報またはトランザクションの購入または取得、または代替アクションから生じる料金および損失。 <br>
  o   8.2.4 当プラットフォームサービスに対しての誤解。 <br>
  o   8.2.5 プラットフォームによって提供されるサービスに関連する、当社が原因ではないその他の損失。 <br>
  •   8.3 私たちは情報ネットワークのメンテナンス、インターネットの接続障害、コンピュータ、通信、または他のシステムのために、停電、悪天候、事故、ストライキ、労働争議、暴動、反乱、暴動、生産性や生産性の欠如、火災、洪水、暴風雨、爆発、戦争、銀行や他のパートナーの理由から、仮想通貨資産市場の崩壊、司法や行政の権限を行うことを政府に命じ、他に我々は制御可能な範囲や動作を制御するために私たちができないことや、第三者ではありません私たちは、原因とあなたの損失によって引き起こされたサービスを遂行することができなかったり、サービスを遅らせることができなかった場合、一切の責任を負いません。 <br>
  •   8.4 当社は、当プラットフォームに含まれる全ての情報、プログラム、テキスト等が如何なるのウイルス、トロイの木馬やその他の悪意のあるプログラムの妨害も受けないことを保証しかねる、故にあなたがログインし、当プラットフォームの如何なるサービスを使用しまたはダウンロードすることは、あなたの個人的な決定であり、発生した損失もあなたの個人負担となる。 <br>
  •   8.5 当社は当プラットフォームにリンクされている第三者のウェブサイトの如何なる情報，製品、業務及びその他の如何なる形式の我々の主体ではないその他のコンテンツの情報、製品、およびサービスに対するいかなる保証も約束もしていませんあなたが第三者のウェブサイトによって提供されるサービスを使用する場合、情報および製品は、あなたの単独の裁量であり、そこから生じるすべての責任も自己負担するものとします。 <br>
  •   8.6 当社は、あなたが当プラットフォーム上で提供するサービスを使用、間違いや不作為、継続性、正確性、信頼性、品質、安定性、完整度及び適時性に対しての如何なるの承諾或いは保証を含むがそれらにかがらない。当プラットフォームにログインし、サービスを使用することに対して、如何なる明示的な若しくは暗示的な保証もしないものとする、当プラットフォームの提供するサービスの適応性、エラー若しくは漏れがないこと、持続性、正確性、信頼性。同時に、当社は、このプラットフォームによって提供されるサービスに関連する技術および情報の妥当性、正確性、正確性、信頼性、品質、安定性、完全性および適時性に対するコミットメントまたは保証をしない。このプラットフォームで提供されているサービスにログインまたは使用することは、お客様が個人的に決定したものであり、リスクと可能性のある損失について責任を負うものとします。当社は、仮想通貨資産市場の不安定性、その価格と価値が随時大幅に変動し、または崩壊する可能性があることを理解した上で、了承し、かつ仮想通貨資産の取引はあなた個人で決定し、選択したものであり。あなた自身が全てのリスク及び発生した損失もあなた自分で負担するものとする。 <br>
  •   8.7 本協議中に規定する当社の保証及び承諾は、我々が当協議及び当プラットフォームで提供するサービスに対しての唯一の保証及び陳述であり、かつ如何なるのその他のルート及び方式で発生した保証及び承諾を代替するものである。書面の口頭の、明示的な、暗示的なは問わない。当プラットフォームが提供するサービスの適応性、間違い或いは漏れがないこと、持続性、正確性、信頼性、品質、安定性、完整度及び適時性を含むが、それに限らない。これらの全ての保証及び陳述はただ当社自身の承諾及び保証をのみを代表するものとし、如何なる第三者が本協議を遵守することを保証するものではない。 <br>
  •   8.8 当社は、本契約に含まれていない、法律に適用される最大限の損害賠償責任を制限、免除または相殺する権利を放棄するものではありません。 <br>
  •   8.9 登録時に、お客様は、本契約に定められた規則に従って当社が行った行為は、自己責任で行うことを認めます。 <br>
  九、契約の終了 <br>
  •   9.1 当プラットフォームは、本契約の条項に従ってプラットフォーム上でお客様のアカウントを解約する権利を留保します。本契約は、アカウント解約の日に終了します。 <br>
  •   9.2 プラットフォームは、本契約の条項に従ってすべてのプラットフォームサービスを終了する権利があり、この契約はプラットフォーム上のすべてのサービスの終了日に終了します。 <br>
  •   9.3 本契約が解除された場合、お客様は、当プラットフォームに対して、元のプラットフォームアカウントの情報を保持または開示することを含むが、これに限定されない、サービスの提供またはその他の義務の継続を要求する権利はありません。または、第三者が、読んだり、送ったりしていない情報を転送します。 <br>
  •   9.4 本契約の終了は、契約違反に対する債務不履行当事者のコミットメントに影響を及ぼさないものとする。 <br>
  十、知的財産権 <br>
  •   10.1 は、このプラットフォームに含まれるすべての知的成果、ウェブサイトのロゴ、データベース、Webサイトのデザイン、テキストとグラフィックス、ソフトウェア、写真、ビデオ、音楽、およびこれらの音、ソフトウェアコンパイラ、関連するソースコードやソフトウェア（を含むが、これらに限定されませんアプレットとスクリプトを含むがそれらに限らない知的財産権はプラットフォームが所有するものとする。上記のコンテンツやコンテンツを商業目的で複製、改変、コピー、送信、または使用することはできません。<br>
  •   10.2 プラットフォームの名称に含まれるすべての権利（のれんおよび商標、ロゴを含むがこれに限定されない）は、全て当社が所有するものとする。<br>
  •   10.3 本契約に同意することにより、複製権、配信権、レンタル権、展示権、演奏権、審査権、放送権を含むが、これに限定されない、プラットフォーム上に公表したあらゆる形式の情報の著作権とみなされます。 、情報ネットワーク送信権、撮影権、適応、翻訳、編集権の権利、および権利の他の転送が排他的にすべての現在のプラットフォームに割り当てられた無償著作権所有者が享受されなければならない、このプラットフォームだけでは侵害訴訟のいずれかのテーマに関する権利を持っており、すべての取得報酬。本契約書の有効期間および本契約に署名する前であっても、本契約書に署名した後であっても、本プラットフォームに投稿する著作権法によって保護されている著作物の内容。 <br>
  •   10.4 あなたは、プラットフォームサービスの使用中に、プラットフォームその他の知的財産権を不正に使用または処分することはできません。あなたは、他のウェブサイト（およびメディア）の使用をどのような形式でも投稿または許可することはできません。 <br>
  •   10.5 プラットフォームへのアクセス、またはプラットフォームによって提供されるサービスの使用は、お客様に知的財産権が移転されたものとはみなされません。 <br>
  十一、情報保護 <br>
  •   11.1 適用範囲 <br>
  o   11.1.1 プラットフォームのアカウント[]を登録するか、アカウントを使用する場合、電話番号、電子メール情報、ID情報を含むがこれに限定されない、このプラットフォームの要件に従って提供する個人登録情報。 <br>
  o   11.1.2 プラットフォームサービスを使用したり、ウェブサイトのページにアクセスしたりすると、サーバーは、IPアドレスや要求したサービスやWebページなどのデータを含む、サーバーに送信する値を自動的に受信して記録します。 <br>
  o   11.1.3 取引記録を含むがこれに限定されない、このプラットフォームでの取引のためにこのプラットフォームによって収集された関連データ。 <br>
  o   11.1.4 法的チャネルを通じてプラットフォームが取得したその他の個人情報。 <br>
  •   11.2 情報の使用 <br>
  o   11.2.1 あなたの追加の同意がない限り、このプラットフォームへの登録は、11.1に記載されているように、このプラットフォーム上のあらゆる種類の情報の収集と使用に同意したものとみなされます。これに限定されるものではありませんが、使用するためにお客様の情報を収集します。 <br>
     11.2.1.1 このプラットフォームサービスを提供する。 <br>
     11.2.1.2 主権国または地域の関係当局の要件に基づいて関連部門に報告する。 <br>
     11.2.1.3 プラットフォームサービスを使用する場合、プラットフォームは、認証、カスタマーサービス、セキュリティ、詐欺監視、アーカイブおよびバックアップの目的でお客様の情報を使用して、プラットフォームによって提供される製品およびサービスのセキュリティを保証します。 <br>
     11.2.1.4 プラットフォームが既存のサービスを改善するための新しい製品とサービスを設計するのを支援する。 <br>
     11.2.1.5 プラットフォームサービスの詳細を知るためには、プラットフォームがマーケティングキャンペーン通知、商用電子情報を送信し、よく使用される広告を置き換えるために関連する広告を提供することに同意すること。 <br>
     11.2.1.6 プラットフォームは、資産の合併、分割、取得または移転を完了する目的で、お客様の情報を非関連の第三者に譲渡または開示します。 <br>
     11.2.1.7 ソフトウェア認証または管理ソフトウェアのアップグレード。 <br>
     11.2.1.8 では、このプラットフォームのサービスに関するアンケートにご参加いただきますようお願い申し上げます。 <br>
     11.2.1.9 政府機関、公共事務機構、協会などとの提携のデータ分析。 <br>
     11.2.1.10 その他すべての合法的な目的及びお客様に授権された用途に使われることが可能するものとする。 <br>
  o   11.2.2 当プラットフォームは、事前にあなたの許可がない限り、他の人にあなたの個人情報を販売したり貸したりしません。また、当プラットフォームは、第三者が個人情報を収集、編集、販売、または配布することを一切許可していません。 <br>
  •   11.3 当プラットフォームは取得した顧客識別情報と取引情報についてを機密情報として扱っており、如何なるの団体または個人に顧客の身分情報及び取引情報を提供してはならないものとするが、関連する主権国家の法律、規制、法令、政令に応じる場合は除外するものとする。 <br>
  十二、すべての取引計算結果の計算は当社によって検証されています。すべての計算方法はウェブサイトに掲載しているが、ウェブサイトの使用妨害或いは誤差がないことを保証しかねます。<br>
  十三、輸出規制　あなたが下記の内容を理解した上で承認する、マルタ共和国の関連の法律に拠りあなたは本プラットフォーム上の如何なる材料（ソフトウェアも含む)を輸出、再輸出、輸入或いは移転してもいけないものとする。故にあなたは主動的に上述違法行為を実施、協力或いは参加しないことを保証しなければならない；このような行為を発見した場合は、積極的的に当社に報告した上でそれの処理を協力すること。 <br>
  十四、本契約に定める権利および義務の移転は、すべての関係者、相続人、執行者と管理者の利益のために権利の譲受人から得ることが義務に拘束されます。あなたは私たちが同意しないという前提の下で第三者に譲渡することはできませんが、我々は常に第三者に本契約に基づく当社の権利および義務を譲渡し、事前に30日あなたの通知を与えることができるものとする。 <br>
  十五、可分割性。本契約のいずれかの条項が無効または違法な管轄権を有する裁判所によって法的強制力がないと見なされた場合、本契約の残りの条項の有効性には影響を与えないものとする。 <br>
  十六、非代理の関係。本契約書のいかなる部分も、代理人、委託者またはその他の代理人を作成、含意または取り扱うものとはみなされません。本協議に別途の規定があった場合除外する。 <br>
  十七、当社或いはお客様の任意の片方が本協議の定めた違約責任或いはその他の責任を追求することを放棄したとしても，その他の責任も放棄したと認定或いは解釈することができないものとする。権利または救済手段を行使する失敗はとして決して解釈してはならない; XVIIは、本契約またはその他の責任放棄の違反で開催されるとの契約の他の違反の権利放棄とみなすか、解釈されるべきではない、私たちやあなたのパーティーのいずれかを棄権します権利または救済の放棄。<br>
  十八、18.タイトルすべての[]見出しは便宜上のものであり、本契約の条項の内容または範囲を拡大または制限することを意図するものではありません。 <br>
  十九、適応の法律　本協議全ての内容はマルタ共和国の法律に基づいたものである、その成立立、解釈、、コンテンツおよび実行が適用され、マルタ共和国の法律の下で作られています。本契約または生じる請求に関連した何らかの理由またはサービス訴訟は、マルタ共和国の法律に従って統治され、解釈され、施行されるものとします。疑義を避けるために、この条項は、当社に対する侵害請求に明示的に適用されます。管轄裁判所または当社に対する訴訟、または当社に関するクレームまたは訴訟は、マルタ共和国にあります。あなたはマルタ共和国の裁判所で訴訟を提起するために無条件に独占的な管轄権を取得しています。また、お客様は、本契約に関連する紛争または問題、または結果として生じるアカウントに無条件に同意するものとします。 <br>
  二十、協議の発効及びその解釈 <br>
  •   20.1 本契約は、当プラットフォームの登録ページの「同意し登録する」をクリックし、登録が完了となり、当プラットフォームのアカウント及びとパスワードの獲得時に発効、当プラットフォームとお客様にとも拘束力が有するものとする。 <br>
  •   20.2 本契約の最終解釈は、プラットフォームが所有します。 <br>
  顧客とマネーロンダリング防止ポリシー政策 <br>
  一、はじめに <br>
  •   1.1 当社はは、「あなたの顧客を知っていること」およびマネーロンダリング防止法および規制を遵守することを約束しており、意図的に「あなたの顧客およびマネーロンダリング防止ポリシーを知っている」ことに違反してはなりません。妥当な管理範囲内で、被疑者のマネーロンダリングからあなたを守るために、安全なサービスを提供するために必要な措置と技術を講じます。 <br>
  •   1.2 お客様のクライアントに対する理解とマネーロンダリング防止ポリシーは、お客様の顧客に対する理解と、お客様の管轄下のさまざまな管轄地域におけるマネーロンダリング防止ポリシーを含む包括的な国際的なポリシーシステムです。弊社の堅牢なコンプライアンス・フレームワークにより、ローカルおよびグローバルレベルで規制要件および規制レベルを満たし、プラットフォームが継続して動作することが保証されます。<br>
  二、顧客とマネーロンダリング対策のポリシーが以下の通りであることを理解してください<br>
  •   2.1 お客様の声明を公布し、マネーロンダリング防止ポリシーを適用し、適用される法律や規制によって定められた基準を満たすように更新する。 <br>
  •   2.2 このプラットフォームを運用するための指針と規則の一部を公布し、更新し、従業員は原則と規則に従ってサービスを提供する。 <br>
  •   2.3 厳格な手段で身元を確認し、マネーロンダリング対策の仕事を担当する専門チームを編成するなど、取引の内部監視および管理のための設計および完全な手続き。 <br>
  •   2.4 リスク予防法を用いた顧客のデューデリジェンスと継続的監督を行う。 <br>
  •   2.5 発生した取引を見直し、定期的にチェックする。; <br>
  •   2.6 疑わしい取引を所管官庁に報告する。; <br>
  •   2.7 身分証明書、住所証明書、取引記録証明書は、通知することなく規制当局に提出された場合、少なくとも6年間は維持されます。 <br>
  •   2.8 取引全体でクレジットカードの使用は禁止されています。 <br>
  三、アイデンティティ情報と検証確認 <br>
  •   3.1 アイデンティティ情報 <br>
  o   3.1.1 異なる管轄区域および異なる事業体のタイプによって、収集する情報が矛盾する場合があります原則として、登録された個人から以下の情報が収集されます： <br>
  o   個人的な基本情報：あなたの氏名、住所（および恒久住所、異なる場合）、生年月日および国籍など認証は、パスポート、身分証明書、または他の異なる管轄区域および発行された身分証明書など、公式または他の同様の機関によって発行された書類に基づいて行われるべきである。あなたが提供する住所は、乗用車のチケットまたは金利のチケットをチェックする、または有権者登録をチェックするなど、適切な方法を使用して確認されます。 <br>
  o   有効な写真：登録する前に、胸にIDの写真を提供する必要があります。 <br>
  o   連絡先：電話/携帯電話番号および/または有効な電子メールアドレス。<br>
  o   3.1.2 あなたが会社またはその他の法人である場合、私たちはあなたまたはあなたの信用口座の最終受益者を決定するために以下の情報を収集します。 <br>
  o   社の登録、登録証明書、覚書、会社の定款のコピー、詳細な証拠の投資会社と会社の所有権表示は、本人の実行を許可このプラットフォームやボード決議に口座を開設することを決定したことを証明、会社を提供するために必要な要件に合わせてディレクター、大株主およびプラットフォームの口座には署名者の身分証明書があり、会社の主な事業住所は会社の住所と異なる場合は郵送先住所が記載されています。会社のローカルアドレスがプライマリ事業所のアドレスと矛盾する場合は、リスクの高い顧客とみなされ、追加の追加ドキュメントが必要です。 <br>
  o   •異なる管轄区域および異なる事業体型に応じて、当社が必要とする他の認証および当局によって発行された文書および必要とみなす文書。 <br>
  o   3.1.3 私たちは、身元情報を英語または中国語でのみ受け取ります。そうでない場合は、あなたの身元情報を英語に翻訳して公証してください。 <br>
  •   3.2 確認確認 <br>
  o   3.2.1 身分証明書の全ページを提出するよう頼む。 <br>
  o   3.2.2 あなたの身元証明書の写真をあなたの胸に入れてください。 <br>
  o   3.2.3 補助文書の写しは、元の文書と照合されなければならない。ただし、信頼できる適切な認証者が、そのコピーが原本の正確で包括的なコピーであることを証明できる場合、そのコピーは容認されます。そのような認証機関には、大使、司法委員、地方保安官などが含まれます。 <br>
  o   3.2.4 は最終的に識別するために、受益者を必要とし、アカウント制御は、個々のエンド顧客が直接所有または管理、および/またはトランザクションの進行が他人の代わりに実行されるかを決定するかを決定することです。事業の場合、大株主（例えば、議決権の10％以上を保有する株主）の身元を確認する必要があります。一般的に、25％の株式は株主の身元を確認する必要があり、通常のリスクとして認識されます。ハイリスクの状況として特定されて株式は議決権または株式の10％以上を持っている場合、株主の身元を確認する必要があります。 <br>
  四、モニタリング取引 <br>
  •   4.1 セキュリティと実際の取引条件に基づいて、日々の取引と時々調整されるコインの最大金額を設定し調整する。 <br>
  •   4.2 取引が登録ユーザーに頻繁に集中している、または不合理な状況がある場合、当社の専門チームが疑わしいかどうかを評価し決定する。;<br>
  •   4.3 例は、トランザクションができるだけ早く逆にしてもよいし、当局に報告することが、あなたに通知していない場合でも、契約やその他の制限措置を拒否し、我々は契約を一時停止するために取ることがあり、疑わしい取引とみなさ;国際的なマネーロンダリング防止規格または管轄区域に準拠していない私たちは、人から拒否する権利を留保 <br>
  •   4.4 人の登録の申請を考えてもよいのPEPは、我々は、一時停止または当社の独自の判断として、疑わしい取引の取引に基づいて終了させる権利を留保しますが、我々はそれを行いますあなたの義務と責任に違反するものではありません。</p>
        `,
        },
    };

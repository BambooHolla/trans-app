...
export class AppSettings {
  ...
  public agreementData = {
    ...
    registAgreement: {
      title: ``,
      agreementFirst: `
    <p>币加所（以下称 “公司”）是本能区块链旗下的一款专门供用户进行数字资产交易和提供相关服务（以下称“该服务”或“服务”）的平台。为了本协议表述之方便，公司和该网站在本协议中合称使用“我们”或其他第一人称称呼。只要登陆该网站的自然人或其他主体均为本网站的用户，本协议表述之便利，以下使用“您”或其他第二人称。为了本协议表述之便利，我们和您在本协议中合称为“双方”，我们或您单称为“一方”。 <br>
重要提示： <br>
我们在此特别提醒您： <br>

...
export class RealtimeReportComponent extends EchartsBaseComponent {
    ...
    createCharts() {
                ...
                normal: {
                    color: {
                        ...
                        colorStops: [
                            {
                                offset: 0,
                                color: "rgba(193,177,127,.1)", // 0% 处的颜色
                            },
                            {
                                offset: 1,
                                color: "rgba(193,177,127,.8)", // 100% 处的颜色
                            },
                        ],
                    },
                },
        ...
        const priceData = this.echartsData.map(
            item => item.avg,
                ...
                },
                {
                    ...
                    axisLabel: {
                        ...
                        textStyle: {
                            ...
                            fontSize: yAxisSize,
                            color: function(e) {
                                if (e > 1e-8) return rangeColor[0];
                                if (e === 0) return rangeColor[1];
                                if (e < -1e-8) return rangeColor[2];
                            },
                        },
            ...
            series: [
                {
                    ...
                    lineStyle: {
                        normal: {
                            width: 1,
                            color: showLineRangeColor
                                ? countedRangeColor // || seriesRandomColor)
                                : seriesColor,
                        },
                    },
